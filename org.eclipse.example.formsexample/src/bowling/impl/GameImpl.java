...
public class GameImpl extends MinimalEObjectImpl.Container implements Game {
	...
	public void setMatchup(Matchup newMatchup) {
		if (newMatchup != matchup) {
			...
			if (matchup != null)
				msgs = ((InternalEObject)matchup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BowlingPackage.GAME__MATCHUP, null, msgs);
			if (newMatchup != null)
				msgs = ((InternalEObject)newMatchup).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BowlingPackage.GAME__MATCHUP, null, msgs);
